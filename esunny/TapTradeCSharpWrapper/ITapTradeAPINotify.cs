...
public class ITapTradeAPINotify : global::System.IDisposable {
  ...
  public virtual void OnRspQryClose(uint sessionID, int errorCode, char isLast, TapAPICloseInfo info) {
    TapTradeCppWrapperPINVOKE.ITapTradeAPINotify_OnRspQryClose(swigCPtr, sessionID, errorCode, isLast, TapAPICloseInfo.getCPtr(info));
  }

  public virtual void OnRtnClose(TapAPICloseInfo info) {
    TapTradeCppWrapperPINVOKE.ITapTradeAPINotify_OnRtnClose(swigCPtr, TapAPICloseInfo.getCPtr(info));
  }
  ...
  public virtual void OnRspQryDeepQuote(uint sessionID, int errorCode, char isLast, TapAPIDeepQuoteQryRsp info) {
    TapTradeCppWrapperPINVOKE.ITapTradeAPINotify_OnRspQryDeepQuote(swigCPtr, sessionID, errorCode, isLast, TapAPIDeepQuoteQryRsp.getCPtr(info));
  }

  public virtual void OnRspQryExchangeStateInfo(uint sessionID, int errorCode, char isLast, TapAPIExchangeStateInfo info) {
    TapTradeCppWrapperPINVOKE.ITapTradeAPINotify_OnRspQryExchangeStateInfo(swigCPtr, sessionID, errorCode, isLast, TapAPIExchangeStateInfo.getCPtr(info));
  }

  public virtual void OnRtnExchangeStateInfo(TapAPIExchangeStateInfoNotice info) {
    TapTradeCppWrapperPINVOKE.ITapTradeAPINotify_OnRtnExchangeStateInfo(swigCPtr, TapAPIExchangeStateInfoNotice.getCPtr(info));
  }

  public virtual void OnRtnReqQuoteNotice(TapAPIReqQuoteNotice info) {
    TapTradeCppWrapperPINVOKE.ITapTradeAPINotify_OnRtnReqQuoteNotice(swigCPtr, TapAPIReqQuoteNotice.getCPtr(info));
  }

  public virtual void OnRspUpperChannelInfo(uint sessionID, int errorCode, char isLast, TapAPIUpperChannelInfo info) {
    TapTradeCppWrapperPINVOKE.ITapTradeAPINotify_OnRspUpperChannelInfo(swigCPtr, sessionID, errorCode, isLast, TapAPIUpperChannelInfo.getCPtr(info));
  }

  public virtual void OnRspAccountRentInfo(uint sessionID, int errorCode, char isLast, TapAPIAccountRentInfo info) {
    TapTradeCppWrapperPINVOKE.ITapTradeAPINotify_OnRspAccountRentInfo(swigCPtr, sessionID, errorCode, isLast, TapAPIAccountRentInfo.getCPtr(info));
  }
